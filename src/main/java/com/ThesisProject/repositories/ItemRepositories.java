...
"	i.expired_date as iExpDate, i.store_id as iStoreId, coalesce(count(cd.id),0) as totalTransc, i.description as iDesc, coalesce(sum(p.click_counter),0) as totalView, i.price as price, i.typeId as type " +
"from mst_item as i " +
